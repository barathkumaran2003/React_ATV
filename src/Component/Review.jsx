            ...
            <div className="r-div2">
                {addondata.map((item, index) => (
                    ...
                    <div className="r-div4">
                        <img src="data:image/png;base64," alt="quote-right"></img>
                    </div>
                    <h4 className="r-head">
                        {item.name}
                    </h4>
